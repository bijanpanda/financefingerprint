...
export function VerificationEmail({ firstName, verificationUrl }: VerificationEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>Verify your email to activate your Vestrofin account</Preview>
          ...
          <Section style={{ padding: "36px 40px 0" }}>
            <div style={{ textAlign: "center", marginBottom: "24px" }}>
              ...
              <Text style={{ color: "#64748b", fontSize: "15px", lineHeight: "1.7", margin: 0 }}>
                Hi {firstName}, thanks for signing up! Click the button below to activate your Vestrofin account.
              </Text>
            </div>
            ...
            <Text style={{ color: "#94a3b8", fontSize: "13px", margin: "0 0 24px" }}>
              If you have not created any account with Vestrofin, you can safely ignore this email.
            </Text>
          </Section>
