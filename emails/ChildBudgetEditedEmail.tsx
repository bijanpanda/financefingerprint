...
interface ChildBudgetEditedEmailProps {
  childFirstName: string;
  editorName: string;
  changeSummary: string;
}

export function ChildBudgetEditedEmail({ childFirstName, editorName, changeSummary }: ChildBudgetEditedEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>{editorName} made a change to your budget</Preview>
          ...
          <Section style={{ padding: "36px 40px 0" }}>
            <div style={{ textAlign: "center", marginBottom: "24px" }}>
              ...
              <Text style={{ color: "#64748b", fontSize: "15px", lineHeight: "1.7", margin: 0 }}>
                Hi {childFirstName}, <strong>{editorName}</strong> made a change to your family budget:
              </Text>
            </div>

            <div style={{ backgroundColor: "#f8fafc", borderRadius: "10px", padding: "16px 20px", marginBottom: "24px", textAlign: "center" }}>
              <Text style={{ color: "#1e293b", fontSize: "14px", margin: 0, fontWeight: "600" }}>
                {changeSummary}
              </Text>
            </div>
            ...
            <Text style={{ color: "#94a3b8", fontSize: "13px", margin: "0 0 24px", textAlign: "center" }}>
              Sign in to Vestrofin to see the full details.
            </Text>
          </Section>
