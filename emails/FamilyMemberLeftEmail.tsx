...
interface FamilyMemberLeftEmailProps {
  initiatorFirstName: string;
  memberName: string;
}

export function FamilyMemberLeftEmail({ initiatorFirstName, memberName }: FamilyMemberLeftEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>{memberName} left your family on Vestrofin</Preview>
          ...
          <Section style={{ padding: "36px 40px 0" }}>
            <div style={{ textAlign: "center", marginBottom: "24px" }}>
              ...
              <Text style={{ color: "#64748b", fontSize: "15px", lineHeight: "1.7", margin: 0 }}>
                Hi {initiatorFirstName}, <strong>{memberName}</strong> has left your family group on Vestrofin.
              </Text>
            </div>
