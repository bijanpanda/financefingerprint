  ...
  return (
    <div className="glass-card rounded-2xl overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between px-5 py-3.5 border-l-4 border-l-blue-500"
      >
        <div className="flex items-center gap-3">
          <span className="text-base font-semibold text-blue-700">Savings</span>
