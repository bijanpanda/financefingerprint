...
export default function LoginPage() {
  ...
  async function handleForgotPassword(e: React.FormEvent) {
    ...
    try {
      ...
      setForgotMessage("Password reset link sent! Check your email inbox (and spam folder).");
    } catch (err: unknown) {
      const code = (err as { code?: string })?.code || "";
        ...
        {!showForgot ? (
          <>
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-2.5 border border-gray-200 rounded-xl font-medium hover:bg-gray-50 disabled:opacity-50 flex items-center justify-center gap-2"
            >
          ...
          <>
            ...
            <form onSubmit={handleForgotPassword} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-2.5 gradient-btn text-white rounded-xl font-medium"
              >
                Send Reset Link
              </button>
            </form>
